...
class RTCViewModelImpl(private val rtcWebSocket: RTCWebSocket) : RTCViewModel {
    ...
    override fun onCreate(kodein: Kodein) {
        ...
        rtcWebSocketSubscription = rtcWebSocket.messageObservable.subscribe({
            when (it) {
                ...
                is SignalMessage.chat -> eventSubject.onNext(RTCViewModel.Event.Chat(ChatMessage(Date(), "opp", it.message)))
    ...
    override fun sendChatMessage(msg: String): Unit {
        send(SignalMessage.chat(msg))
